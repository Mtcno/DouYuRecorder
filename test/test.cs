...
namespace test
{
    ...
    class test
    {
        ...
        static string DyGetRealRtmp(string url)
        {
        ...
        {
            string url = "https://www.douyu.com/5621575";
            string realrtmp = DyGetRealRtmp(url);
            if (realrtmp != null)
                Console.WriteLine(realrtmp);
